...
<tbody>
<tr>
<td class="org-left">1.64.2</td>
</tr>


<tr>
<td class="org-left">f80445acd5a3dadef24aa209168452a3d97cc326</td>
</tr>
...
## Unendliche Sequenzen :)
    ...
    val firstTenRandomNumbers: int list =
      [7726; 29211; 32573; 38037; 41633; 60191; 77517; 78286; 84946; 98801]
    val it: int list =
      [7726; 29211; 32573; 38037; 41633; 60191; 77517; 78286; 84946; 98801]
...
## Mapping (1)
    ...
    val it: int list = [8; 27; 125; 343; 1331; 2197; 4913]
...
## Mapping (2)
    ...
    val ps: (string * string) list =
      [("http://www.bing.com",
        "<!doctype html><html lang="de" dir="ltr"><head><meta name="th"+[93656 chars]);
       ("http://www.google.com",
        "<!doctype html><html itemscope="" itemtype="http://schema.org"+[49997 chars])]
    val ls: int list = [93717; 50058]
    val it: unit = ()
...
## Basics
    ...
    val listOfFunctions: (int -> int) list =
      [<fun:listOfFunctions@707>; <fun:listOfFunctions@707-1>]
    val it: unit = ()
